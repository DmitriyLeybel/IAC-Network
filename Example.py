...
net.activate(200) # Spreads the activation in the network for a select number of epochs
net.check('Jets','Sharks') # Checks the final values of the desired nodes
